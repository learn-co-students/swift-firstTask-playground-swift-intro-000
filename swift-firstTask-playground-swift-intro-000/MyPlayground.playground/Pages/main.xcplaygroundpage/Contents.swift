...
*/
var currentBankAccountBalance : Int = 1000
...
*/
print("I have $\(currentBankAccountBalance) dollars in my bank account.")
...
print("I now have $\(currentBankAccountBalance) dollars.")
...
// Yes, I can change the name of a variable easily.
