...
*/
print("I just got a new puppt named \(petName) and she is awesome!")
...
*/
petName = "Rusty"
// cant change the pet name, because it was assigned as a constant above.  Constants cant be changed.  To fix, you would need to change the type of the variable by assigning with var instead of let. 
