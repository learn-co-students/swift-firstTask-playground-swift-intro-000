...
*/
var accountBallance:Int=12100000
...
*/
print("I have $\(accountBallance) in my bank account.")
...
*/
print("I now have $\(accountBallance+100).")
...
*/
myPuppy = "notBella"
//: You cannot assign `myPuppy` to a new value because it is a _constant_, and the values of constants cannot change
/*:
