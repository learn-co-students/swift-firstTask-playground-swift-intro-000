...
*/
//should probably say to assign a value as one is needed later
...
*/
print("I just got a new puppy named \(dogName)")
...
*/
dogName = "Not Bella"
//we assigned Bella as a constant so the value cannot be changed
//xcode will ask you to change the constant to a variable to fix the problem
