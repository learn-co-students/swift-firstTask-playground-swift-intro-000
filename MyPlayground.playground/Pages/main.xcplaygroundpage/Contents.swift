...
*/
var myBankAccountBalance: Int = 450
...
*/
// This is not possible, because the variable is a constant.
// Constants can only be assigned a value once.
// You try to assign a value then xcode genrates an error.
