...
*/
// you can not do this because the original variable is a constant and cannot be changed like a variable can. An error message comes up saying that you can not redeclare the variable.
