 ...
 */
print("I have \(bankAccountBallance) in my bank account.")
 ...
 */
bankAccountBallance = bankAccountBallance + 100
 ...
 */
//unable to change puppy name, as it was declared as a constant
let newPuppy = "Dexter"
