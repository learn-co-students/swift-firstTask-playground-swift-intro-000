...
*/
var accountBalance = 540

print("I choose var because it would allow you to change the value as the ammount changes")
...
*/
print("My new puppy is named \(puppyName)")
...
*/
print("You cannot change a constant.")
