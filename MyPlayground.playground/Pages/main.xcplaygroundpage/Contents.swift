...
*/
puppyName = "Maxine"
// When trying to update the value of the puppyName, I get an error stating "Cannot assign to value: 'puppyName' is a 'let' constant"
// Changed let to var to remove the error.
