...
var BankBalance: String = "10,000"
print("Your Account Balance is \(BankBalance)")
...
print("My New Puppy name is \(mypuppy)")
...
print("I just got a new puppy named \(mypuppy) and she is awwesome!")
...
// I am not allowed to do this because the "mypuppy" is a is a constant and it can not be changed hence there is a error in Xcode
