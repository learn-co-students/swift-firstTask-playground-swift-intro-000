...
*/
print("I have $\(acctBal) in my bank account.")
...
//No this cannot be done as puppyName is a constant. 
//It gives error if we re-assign it a different value.
/*:
