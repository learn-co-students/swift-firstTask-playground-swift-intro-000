...
*/
// this cannot be done unless the constant is changed to a variable - let cannot be altered later in the program; but var can change later in the program. 
