...
print("I just got a new puppy named \(myPetName) and she is awesome!")
...
*/
print("I have $\(accountBalance) in my back account.")
...
*/
print("We have declared my puppy's name as a constant (using the **let** keyword instead of var), which is why the compiler would warn me if I were to try and change its value.")
