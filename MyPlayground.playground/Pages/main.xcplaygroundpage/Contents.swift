...
// The name Bella can not be changed because a let constant was used to define the name of the puppy. When attempting to change the name you recieve the error message "Use of unresolved identifier"
