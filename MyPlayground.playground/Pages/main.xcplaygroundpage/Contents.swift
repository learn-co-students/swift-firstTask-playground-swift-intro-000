...
*/
print("I just got a new puppy named \(nameOfNewPuppy) and she is awesome!")
...
*/
var bankAccountDeposite = 100.00
var balance = bankAccountBalance + bankAccountDeposite
...
*/
No I get error because I set nameOfNewPuppy as a constant and the value cannot be changed.
