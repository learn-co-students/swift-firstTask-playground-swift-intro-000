...
*/
print("I just got a nuew puppy named \(myPetName) and she is awesome")
...
myPetName = "tella" //you get a compile error

//Constants can't be changed after initialization
/*:
