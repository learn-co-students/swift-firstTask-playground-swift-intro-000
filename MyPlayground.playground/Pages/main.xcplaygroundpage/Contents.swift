...
*/
print("I just got a new dog named \(nameOfDog) and she is awesome!")
...
*/
// It won't work because I have declared nameOfDog to be a constant
// If I try there will be an error
nameOfDog = "Poochie"
