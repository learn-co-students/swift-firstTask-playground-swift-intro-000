...
puppy = "Bella"
print(puppy)
print("Hey guys, I just bought my first puppy, her name is \(puppy)")
...
*/
// No you cannot do this because you use "let". You cannot change the string in "let"
