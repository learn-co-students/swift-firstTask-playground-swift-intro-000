...
*/
print("I have $\(savingsAccount) in my bank account.")
...
*/
savingsAccount += 100
print("I now have $\(savingsAccount).")
...
*/
//The puppy's name is stored in a constant variable which cannot be changed
