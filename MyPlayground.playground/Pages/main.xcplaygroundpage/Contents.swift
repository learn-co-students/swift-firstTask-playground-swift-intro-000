...
var BankAccountBalanceJanuary = Int(3000)
...
print("I just got a new puppy named \(DogsName) and she is awesome")
...
print("I have $ \(BankAccountBalanceJanuary) in my bank account.")
...
*/
// write your code here
BankAccountBalanceJanuary = 3100
print("I now have $ \(BankAccountBalanceJanuary)")
...
// No, We can't do that. Because "Bella" is a constant which can't be changed.
