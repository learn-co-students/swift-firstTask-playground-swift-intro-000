...
*/
print("I just got a new puppy named \(pupName) and she is awesome!")
...
*/
print("I have \(accountB) in my bank account.")
...
*/
//You cannot do this because the puppy's name is a constant'
