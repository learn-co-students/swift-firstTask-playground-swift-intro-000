...
*/
var currentAccountBalance: Double = 3899.93
print (currentAccountBalance)
var balance = "I have \(currentAccountBalance) in my bank account."
...
*/
var printSentence = "I just got a new puppy named \(newPuppy) and she is awesome!"
print(printSentence)
...
*/
currentAccountBalance = 3999.93
balance = "I now have \(currentAccountBalance) in my bank account."
...
*/
newPuppy = "Lucky"
//Cannot change the newPuppy as it's a constant and not a variable
