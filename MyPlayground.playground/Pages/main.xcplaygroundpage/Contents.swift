...
*/
print("I just got a new puppy named \(lovablePupName) and she is awesome!")
/*: question5
...
*/
// This does not work because lovablePupName was declared as a constant and not a variable.  An error is thrown because the value "Bella" is not mutable.
/*:
