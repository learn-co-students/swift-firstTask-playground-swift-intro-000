...
*/
var myBalance: Int = 700
// I think myBalance is a good name because the name of this variable is camelcase which its attribute makes it easily readable for everyone involved.
// I should declare it using var because the balance can change over time. 
// It should be of type Integer because balance involves number.
...
myPuppy = "Blake"
print(myPuppy)
// I can do this because I have already declared myPuppy to be a variable. No error takes place when I try to change the value (puppy name) because the variable myPuppy is mutable which means you can change its value to Blake or something else.
