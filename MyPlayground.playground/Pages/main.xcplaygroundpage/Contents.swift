...
*/
//Cannot change puppy's name to something else, it is a constant. I thought I would never rename her, must create new variable or constant for new puppy name
let newPuppyName = "Something Else"
