...
print("I just got a puppy name \(puppyName) and she is awesome!" )
...
// No I cannot do this because I've set the name Bella with a constant, and constants cannot be changed. when I tried to change it, I received an error. If I want to change it, I would need to change let into var.
