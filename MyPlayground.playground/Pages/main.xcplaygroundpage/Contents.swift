 ...
 */
print("I have $\(bankBalance) in my banck account)")
 ...
 */
newPuppy = "Fred"
/* we get an error code because we asigned newPuppy as a constant (let) and once that is set there is no changing.
 /*:
