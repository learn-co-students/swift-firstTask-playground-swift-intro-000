...
*/
    print("I just got a new puppy named",puppy_name)
...
// We cannot change the string value when we use let, we have to change it to var in order to make the change.
