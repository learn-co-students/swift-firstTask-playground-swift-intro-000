...
print("I just got a new puppy named \(nameOfNewPuppy) and she is awsome!")
...
*/
//:
nameOfNewPuppy = "Silly"

// nameOfNewPuppy is a let constant you cannot do this because let constant's are constant if you try to change a constant after it is defined you will get an error */
