...
*/
myPuppy = "Blake"
// An error takes place when I try because myPuppy is a constant (let). I cannot change the puppy name to something else because the value of constant is immutable. 
