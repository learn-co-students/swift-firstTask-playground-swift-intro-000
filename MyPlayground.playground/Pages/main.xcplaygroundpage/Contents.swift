...
*/
var bankAccountBalance: Int = 24957
...
*/
print("I just got a new puppy named Bella and she is awesome!")
...
*/
puppyName = "Cocoa"
// Cannot assign to vaule: 'puppyName' is a 'let' constant.
// Constants are immutable and thus cannot be changed once set.
/*:
