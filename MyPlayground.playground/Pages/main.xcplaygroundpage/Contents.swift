...
var bankAccountBalance : Int = 1000000
...
let nameOfMyFirstPuppy = "Bella"

/*: question3
### 3. Use the `print()` function to print the name of your new puppy to the console.
*/

print("Name of my first puppy is \(nameOfMyFirstPuppy)")
...
print("I just got a new puppy named \(nameOfMyFirstPuppy) and she is awesome!")
...
// Cannot change the value stored in a constant. When we try to change, it thows the error  - Cannot assign to value: 'nameOfMyFirstPuppy' is a 'let' constant. It also tries to provide a solution - change 'let' to 'var' to make it mutable
