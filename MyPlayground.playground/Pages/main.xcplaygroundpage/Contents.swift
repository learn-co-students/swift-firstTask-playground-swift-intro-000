 ...
 */
var bankAccountBalance: Int = 0 //This should be Double but for the sake of the exercise, declared as Int :)
 ...
 */
puppyName = "Joe" // puppyName is a constant, therefore it can not mutate
