...
*/
var gideonsBankAccountBalance = 100
...
*/
print("I just got a new puppy named \(gideonsNewPuppy) and she is awesome!")
...
*/
print("I have $\(gideonsBankAccountBalance) in my bank account")
...
*/
gideonsBankAccountBalance = gideonsBankAccountBalance + 100
print("I now have $\(gideonsBankAccountBalance)")
