...
*/
    print("I have \(Account) in my bank account.")
...
*/
    ...
    //you can't change the puppys name because tha variable is immutable you have to change 'let' to 'var' to make it mutable and if you
    //try to the Playground execution fails giving the error
    //main.xcplaygroundpage:20:5: note: change 'let' to 'var' to make it mutable
    //  let puppyName = "Bella"
    //  ^~~
    //  var
