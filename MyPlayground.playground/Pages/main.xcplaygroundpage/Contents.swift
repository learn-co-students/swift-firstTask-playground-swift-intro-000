...
*/
print("You cannot change the puppy's name because it has been declared as a constant (let). When you try an error appears because a constant by definition remains the same- it cannot be changed like a variable")
