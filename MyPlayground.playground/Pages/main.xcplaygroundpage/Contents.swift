...
*/
//myPuppyName = "Daisy" It gives me an error if I assign Daisy to myPuppy Name because I declared it in the beginning as a constant. So, "Bella" is stored into the variable call myPuppyName, to change the puppy name, I would need to declare myPuppyName as a variable string because this will let me store anything I want to store in myPuppyName as long as it's a string.
