...
*/
// write your code here
print("I have $\(accountBal) in my bank account.")
...
*/
// write your code here
//nothing will happen other than a fault.  You can't change the value of a constant once it has been set.
