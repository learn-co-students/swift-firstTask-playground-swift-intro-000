...
*/
print ("I just got a new puppy named \(puppyname) and he is awesome!")
...
*/
print ("I have $ \(bankaccountbalance) in my my bank account.")
...
*/
bankaccountbalance = 154
print ("I now have $ \(bankaccountbalance) in my my bank account.")
