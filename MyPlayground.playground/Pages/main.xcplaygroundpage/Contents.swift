...
*/
var MyBankAccountBalance: Int = 2000 //Create an integer type variable for my bank account balance with initial balance of $2000
...
*/
let MyDogsName = "Bella" //Create a string type constant that has my new puppy's name in it
...
*/
print(MyDogsName) // Use the print function to print my puppy's name to the console
...
*/
print("I just got a new puppy named \(MyDogsName) and she is awesome!") // Prints a sentence using string interpolation
...
*/
print("I have $\(MyBankAccountBalance) in my bank account.")
...
*/
//MyDogsName = "Snowball"
//This did not work and gave an error as initially we assigned the string "Bella" as a constant, and thus are unable to change it!
