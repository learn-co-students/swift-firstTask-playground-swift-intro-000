...
*/
print("I just got a new puppy named \(nameOfPuppy)")
...
*/
print("I have $\(bankAccountFunds) in my bank account")
...
*/
print("I now have $\(bankAccountFunds + 100)")
