...
*/
let myBabyDoggy = "Schmoopsie Poo"
...
*/
print("\(myBabyDoggy) can kick your ass bub" + " \(currentBankAccount)")
...
*/
print("I just got a new puppy named \(myBabyDoggy) and she is awesome")
...
*/
print("I have $\(currentBankAccount) in my bank account")
...
*/
currentBankAccount += 100
print("I now have $\(currentBankAccount)")
//Just typing currentBankAccount + 100 didn't save? Had to do +=
