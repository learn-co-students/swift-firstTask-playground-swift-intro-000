...
*/
print ("I just got a new puppy named \(puppyName) and she is awsome!")
...
*/
print ("I have £\(terrysBankBalance) in my account")
...
*/
// You can't do this as we declared the puppy's name using let which makes it  a constant and can't be changed.
