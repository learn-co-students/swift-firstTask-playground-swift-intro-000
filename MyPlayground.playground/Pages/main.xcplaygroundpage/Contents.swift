...
*/
print ("I just got a new puppy named \(puppiesName)")
...
*/
var puppiesName = "Spot" //invalid redeclaration as previously declared as a constant and printed
