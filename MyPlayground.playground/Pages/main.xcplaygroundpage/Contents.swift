...
*/
var myCheckingAccountBalance = 1000000
/*: question2
...
*/
print ("I just got a new puppy named \(myPuppysName) and she is awesome!")
/*: question5
### 5. Use the `print()` function to print the sentence "I have $<balance> in my bank account." to the console.
*/
print ("I have $\(myCheckingAccountBalance) in my bank account")
/*: question6
...
*/
var myBirthdayGift = 100
myCheckingAccountBalance = myCheckingAccountBalance + myBirthdayGift
print ("I now have \(myCheckingAccountBalance)")
/*: question7
...
*/
//myPuppysName = "Nina"
//You cannot change the value of a constant. her name will always be Bella
/*:
