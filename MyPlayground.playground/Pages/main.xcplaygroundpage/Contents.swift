...
*/
// the puppys name was set as a constant, meaning its value cannot be change, if you attempted to change the puppys name it would return as an error
