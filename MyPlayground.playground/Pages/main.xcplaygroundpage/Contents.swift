...
//I cannot change the name of my puppy to something else because I declared myPuppy name as a constant, when I try to update the constant the compiler gives me an error
//because a constant is immutable, meaning it cannot be changed ever.
