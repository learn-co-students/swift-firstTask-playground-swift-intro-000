...
*/
var bankAccountBalance = 10001.01
...
*/
// I cannot do this.  I used "let" when creating the variable so it is now immutable, and trying to assigne a new name will throw raise an error.
