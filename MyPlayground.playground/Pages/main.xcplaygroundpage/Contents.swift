...
*/
var bankAccountBalance: Int = 131
...
*/
//It cannot be done because the puppy's name is a constant variable ("let"), which means it stays the same forever, unlike a "var" variable, which can change over time.
