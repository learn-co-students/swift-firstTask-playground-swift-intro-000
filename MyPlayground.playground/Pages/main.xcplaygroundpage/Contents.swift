...
*/
var bankAccoutBalance : Int = 1000000
...
*/
print("I have $\(bankAccoutBalance) in my bank account.")
...
*/
bankAccoutBalance += 100
print("I have $\(bankAccoutBalance) in my bank account now.")
