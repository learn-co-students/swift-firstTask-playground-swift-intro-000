...
*/
puppyName = "Cassie"
//This can not be done. Swift throws an error because this is a let constant and can not change its value. Constants values can not change once they have been initialized.
