...
//Should be declared as var, because it'll hopefully change in the future. It's an int, because we want to be able to add and subtract from it
...
print("I now have $\(bankBalance) thanks to my grandmother!")
...
*/
//puppyname = shithead
//the code doesn't run, because puppyname was declared as a constant.
