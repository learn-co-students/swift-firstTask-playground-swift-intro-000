...
*/
print ("I just get a new puppy named \(myPuppyName) and she is awesome!")
...
*/
let myPuppyName = "Chase"

/* This can not be done because the String myPuppyName is already a Constant.
 */
/*:
