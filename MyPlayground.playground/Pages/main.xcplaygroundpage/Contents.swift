...
*/
// write your code here
print("I have $\(act_balance) in my back account.")
/*: question6
...
*/
// write your code here
//No, this cannot be done. Bella's name was declared as a constant so any attempt to change it would result in an error.
/*:
