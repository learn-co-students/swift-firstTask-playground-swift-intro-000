...
*/
print("I just got a new puppy named \(newPuppy) and she is aweseom!")
...
// This will not work because the string newPuppy is fixed with "let". It must be a var.
