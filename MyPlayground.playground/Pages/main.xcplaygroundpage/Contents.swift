...
*/
let cutestPuppyEver = "Bella" //shame about the twilight name steal...
...
*/
print("I just got a new puppy named \(cutestPuppyEver) and she is awesome!")
...
*/
bankAccountBal += 100
print("I now have $\(bankAccountBal) in my bank account.")
