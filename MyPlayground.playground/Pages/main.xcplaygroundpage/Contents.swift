...
*/
// You can´t do that because we define the puppy name as a constant. It will appear an error because you are not supposed to change the value of a constant.
