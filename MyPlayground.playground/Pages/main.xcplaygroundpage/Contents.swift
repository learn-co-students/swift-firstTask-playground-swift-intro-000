...
*/
var currentAccountBalance: Int
currentAccountBalance = 20
...
*/
print ("I have $\(currentAccountBalance) in my bank account.")
...
*/
print ("I now have $", currentAccountBalance + 100)
...
*/
/* No, because i set newPuppyName as a constant. If I attempt to change it, I will get an error stating that newPuppyName is a constant, if I want to change the value, I will need to change let to var.
*/
