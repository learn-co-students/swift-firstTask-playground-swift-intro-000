...
*/
print("I have $\(balanceAccount) in my bank account.")
...
*/
balanceAccount += 100
print("I now have $\(balanceAccount).")
/*: question7
...
*/
//puppyName = "Max"  Cannot do this. If i try, Xcode will warn me that "puppyName" is a "let" constant. A constant cannot change over time once is initialized.
