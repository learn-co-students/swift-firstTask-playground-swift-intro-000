...
*/
var myBankAccount: Double
myBankAccount = 1000.01
print(myBankAccount)
...
*/
myPuppyName = "Joaquin Phoneix" //cannot change immutable variable created with "let"; should have used "var" if I wasn't so set on that puppy name
