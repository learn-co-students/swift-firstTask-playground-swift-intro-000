...
*/
    var bankAccountBalance: Int = 200000
...
*/
  //I can't change the name of the puppy variable because it is a constant. I would have to change the variable to a var in order to modify the name
