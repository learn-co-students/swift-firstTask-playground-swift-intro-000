...
print("I just got a new puppy named \(newPuppyName)")
...
print("I have a $\(balance) in my bank account")
...
let newPuppyName = "Tommy"

//main.xcplaygroundpage:21:5: note: 'newPuppyName' previously declared here
//let newPuppyName = "Bella"
/*:
