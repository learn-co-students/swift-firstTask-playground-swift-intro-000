...
//We declare it as var because the bank account balance is subject to change. If the bank account balance never changed, we would use let.
//It's type Int because we want the variable to store an integer (number), not a string.
...
*/
var newBankAccountBalance: Int = bankAccountBalance + 100
print("I now have $\(newBankAccountBalance).")
...
*/
puppyName = "Lucy"
//We cannot change the name of the puppy because previusly we defined it as a constant.
/*:
