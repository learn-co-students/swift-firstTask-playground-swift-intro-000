...
*/
nameOfPuppy = "Ralph"
//This can't be done because CONSTANTS can only be initialized once. We have already initialized 'nameOfPuppy' with Bella.
//An error arises saying 'nameOfPuppy' may only be initialized once.
