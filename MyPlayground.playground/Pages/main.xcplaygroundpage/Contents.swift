...
*/
print("I have a $\(bankAccountBalance) in my bank account")
...
//You cannot make this change as the "puppy" variable was set to a constant (let). Constants cannot be altered after they are declared. Should a programmer wish to declare a variable in such a way that they could later alter the value of the variable they should use var instead of let. However, renaming an animal is inappropriate so let was the right choice in this instance.
