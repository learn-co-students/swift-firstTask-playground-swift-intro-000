...
*/
accountBalance = 0 // need to initialize the variable on top of just declaring it prior to interpolation
...
*/
// puppyName = "newName" can't do this cause puppy name is a constant, cannot redifine by definition
