...
*/
var bankAccountBalance: Int //type annotations
...
*/
let puppyName = "Bella" //type inference
...
*/
print("The sacrificial puppy \(puppyName) has arrived, and I got it at a good price. :)")
...
*/
print("I can't change the name of my puppy \(puppyName). This will cause an error in the code as constants can't be changed from their original value.")
