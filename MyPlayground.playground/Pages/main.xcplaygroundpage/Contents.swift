...
*/
// can't change the puppy's name because it is a constant. When I try <let puppyName = "Something else"> I get a Swift Compiler Error: Invalid redeclaration of 'puppyName'.
