...
*/
print("I just got a puppy named \(myPuppy) and she is awsome!")
...
*/
print("I have $\(emikosBankAccount) in my bank account.")
...
*/
print("I now have $\(emikosBankAccount+100).")
...
*/
myPuppy = "Pop"
//I can't change my puppy's name because I declared her name Bella as a constant. I need to declare her name as a variable in order to change it.
