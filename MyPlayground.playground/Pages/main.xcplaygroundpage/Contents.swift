...
*/
// write your code here
print("I got a new puppy named \(puppyName) and she is awesome")
...
*/
// write your code here
    print("I have $\(bankStatement) in my bank account")
...
*/
// write your code here
    bankStatement = bankStatement + 100;
    print("I now have $\(bankStatement).")
