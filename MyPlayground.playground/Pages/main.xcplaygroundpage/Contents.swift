...
*/
// write your code here
print("I have $\(accountBalence) in my bank account.")
...
// write your code here
accountBalence = 100
print("I now have $\(accountBalence).")
...
*/
// write your code here
"You can not. The name was set as a let. Once set you cannot change this. You get warnings indicating that it is not a var."
