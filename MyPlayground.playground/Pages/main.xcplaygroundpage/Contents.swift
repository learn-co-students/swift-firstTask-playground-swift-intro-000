...
*/
print("I just got a new puppy named \(myNewPuppysName) and she is awesoe!")
...
*/
"I can not. It was declared as a constant. I would need to make it a variable first."
