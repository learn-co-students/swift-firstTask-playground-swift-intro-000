...
*/
print("I just got a new puppy name \(name) and she is awesome!")
...
*/
name = "Katie"
//You cannot do this because you made the name for the dog a constant, so it can not be changed. If you try you get an error that you can't assign a new value to a string that was created with 'let'
