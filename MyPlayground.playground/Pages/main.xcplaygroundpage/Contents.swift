...
*/
I can not do this. I already declared or initialized myPuppy as a constant, therefire I cannot change the value to something else. Doing so will through out an error from Xcode.
