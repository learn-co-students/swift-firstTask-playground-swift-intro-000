...
*/
print ("I just got a new pappy named \(puppyName) and she is awesome")
...
print ("I now have $\(myAccountBalance)")
...
*/
puppyName = "Luna" // I can't do this becuase the name of my puppy is a constant (let) and the constant values can't be changed.
