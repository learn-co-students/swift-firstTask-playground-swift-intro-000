...
print("I have $\(ckAccountBalance) in my bank account.")
...
ckAccountBalance += 100
print("I now have $\(ckAccountBalance).")
...
// No, since the name Bella is declared as Constant, we can't change it any more.
