...
*/
print("I just got a new puppy names \(puppyName) and she is awesome!")
...
*/
print("I have $\(bankAcctBal) in my bank account.")
...
*/
bankAcctBal = bankAcctBal + 100
print("I now have $\(bankAcctBal) in my bank account.")
...
*/
puppyName = "Coco"
// puppyName cannot be change because it is a constant. if attempt to change puppyName, an error will appear as "error: cannot assign to value"
