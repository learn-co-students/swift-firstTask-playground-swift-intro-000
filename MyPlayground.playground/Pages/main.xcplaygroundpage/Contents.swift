...
*/
print ("I have $\(simpleBalance) in my bank account.")
...
*/
simpleBalance = 100.00
print ("I now have $\(simpleBalance).")
...
*/
//You cannot change Bella's name as it was a "let" constant. The name will stick with her forever.
/*:
