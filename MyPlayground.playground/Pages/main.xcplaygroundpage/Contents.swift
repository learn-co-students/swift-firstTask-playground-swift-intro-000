...
*/
var balance = 54 // write your code here
...
*/
print("I just got a new puppy named\(puppyName) and she is awesome!")// write your code here
...
*/
balance = 154
print("I now have $\(balance)")// write your code here
...
*/
print("A constant cannot be changed once it is declared.")// write your code here
