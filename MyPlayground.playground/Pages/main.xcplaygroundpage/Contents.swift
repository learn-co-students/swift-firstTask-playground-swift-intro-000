...
*/
var accountBalanceWas = 100000
var accountBalanceNow = 100100
...
*/
print("I have $\(accountBalanceWas) in my bank account.")
...
*/
print("I now have $\(accountBalanceNow).")
...
*/
print("My Puppy name changed to \(puppyNameNow).")
