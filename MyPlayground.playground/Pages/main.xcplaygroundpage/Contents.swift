...
*/
print("I now have a balance of $\(accountBalance + 100).")
...
*/
// You cannot change the name of puppyName because it is a constant that cannot be altered.
