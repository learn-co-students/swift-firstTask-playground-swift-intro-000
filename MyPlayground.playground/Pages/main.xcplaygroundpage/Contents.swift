 ...
 */
// write your code here - Cant do that because the puppyname Bella is assigned to a constant that cant be changed. Only way to change
// puppy name is to create a new constant to hold the name.
