...
*/
print ("I just got a new puppy named \(my_puppy) and she is awesome!")
...
*/
account_balance = 100
print ("I have $\(account_balance) in my bank account.")
...
*/
account_balance += 100
print ("I now have $\(account_balance).")
