...
var bankAccountBalance: Double = 8675309.12;
...
*/
// write your code here
let birthdayGift: Double = 100.00
bankAccountBalance += birthdayGift //floating point error :(
...
*/
// write your code here
//can't do it because it's a constant... 
//best thing to do would be to refactor and make variables more scalable (or stop overusing constants)... ie:
//var dogName: String = puppyName; //place this up top
let secondDogName: String = "Lady" //give her another chance
dogName = secondDogName;
