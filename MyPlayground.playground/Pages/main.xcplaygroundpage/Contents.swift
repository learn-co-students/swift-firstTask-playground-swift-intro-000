...
var bank_account_balance: Int = 100
...
print("I just got a new puppy named \(puppy_name) and she is awesome!")
...
print("I have $\(bank_account_balance) in my bank account.")
...
print("I now have $\(bank_account_balance + 100).")
