...
*/
print( "I just got a new puppy named \(petPuppy) and she is awesome!" )
...
*/
print( "I have $\(accBal) in my bank account." )
...
*/
petPuppy = "Ella"
print( "My pet has a new name \(petPuppy)" )
