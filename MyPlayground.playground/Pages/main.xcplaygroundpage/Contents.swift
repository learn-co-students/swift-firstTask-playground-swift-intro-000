...
*/
var bankAccountbalance = Int(99) // write your code here
...
*/
let puppyName = ("bella")// write your code here
...
*/
print (puppyName)// write your code here
...
*/
print ("I just goy a new puppy named \(puppyName) and she is awesome!")// write your code here
...
*/
print ("i have $\(bankAccountbalance) in my bank account")// write your code here
...
*/
var gift = (100)
print ("I now have $\(bankAccountbalance + gift). ")// write your code here
...
*/
puppyName = ("perrito")// write your code here
//i cant change it because i used let... when i declared the puppyName
