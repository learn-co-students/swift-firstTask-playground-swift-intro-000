...
*/
print("My new dog's name is \(newPuppy)")
...
*/
print("I just got a new puppy named \(newPuppy) and he is awesome!")
...
*/
print("I have $\(bankAcctBalance) in my bank account.")
...
*/
bankAcctBalance += 100
print("I now have $\(bankAcctBalance).")
