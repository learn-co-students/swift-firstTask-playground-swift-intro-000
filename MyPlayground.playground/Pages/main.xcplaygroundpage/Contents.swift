...
*/
var bankAccountBalance: Double = 50.00
...
*/
let newPuppy: String = "Bella"
bankAccountBalance = bankAccountBalance - 50.00
...
*/
print("I just got a new puppy names \(newPuppy) and she is awesome!")
...
*/
//This isn't possible, Her name was declared as a constant, and changing it would require a code refactor.
/*:
