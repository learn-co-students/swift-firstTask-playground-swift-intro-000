...
*/
// I am unabled to change my puppy's name because I declared it as a constant. Once I try to do that I get an error. If I know that I will want/need to change the name I should use var instead.
/*:
