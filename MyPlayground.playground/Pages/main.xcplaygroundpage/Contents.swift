...
*/
// write your code here
//ANSWER: Can't currently do it because Bella is a let constant. The puppys' name is not mutable. In order to change the name, the variable needs to be declared as a var.
