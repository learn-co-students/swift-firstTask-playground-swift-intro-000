...
*/
print("I have a $\(money) in my bank account.")
...
*/
newPuppy = James
//This wont work because I assigned newPuppy to be a constant and not a variable. Now changes can be made when declared as a constant.
