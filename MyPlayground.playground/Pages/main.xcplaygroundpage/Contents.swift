...
*/
myBankAccount = 100100
print("I now have $\(myBankAccount) in my bank account")
...
*/
//no. Because I declared myPuppyName as a constant and not a variable.
