...
// unable to change becuase previously declared this as a const variable which can't be changed, ever. As you can see it gives me an error message and tells me what is wrong
// puppyName = "Posey"
