...
*/
var myBankAccountBalance = 650.00
...
*/
print ("I just got a new puppy named \(myDogsName) and she is awesome!")
...
*/
var accountString = "I have $\(myBankAccountBalance) in my bank account."
print (accountString)
...
*/
myBankAccountBalance = 750.00
var updatedBalanceString = "I now have $\(myBankAccountBalance)"
print (updatedBalanceString)
