...
*/
print("I have $\(bankAccountBalance).00 in my bank account")
...
print("I now have $\(bankAccountBalance).00")
...
*/
myPuppy = "Queen"
//You can do this but you must change the constant to a variable
print("My new puppies name is \(myPuppy)!")
